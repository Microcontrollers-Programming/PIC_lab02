...
# 10 "D:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c99\\stdlib.h" 3
...
void __attribute__((picinterrupt(("irq(8), base(0x00008), high_priority")))) INT0_ISR()
{
    __asm("nop");
    PIR1bits.INT0IF = 0;
    a = a + 12;
...
void __attribute__((picinterrupt(("irq(48), base(0x00008), high_priority")))) INT1_ISR()
{
    __asm("nop");
    PIR6bits.INT1IF = 0;
    a = a * 5;
...
void __attribute__((picinterrupt(("irq(80), base(0x00008), low_priority")))) INT2_ISR()
{
    __asm("nop");
    PIR10bits.INT2IF = 0;
    a = a % 10;
...
void __attribute__((picinterrupt(("irq(7), base(0x00008), low_priority")))) IOC_ISR()
{
    __asm("nop");
...
void __attribute__((picinterrupt(("irq(default), base(0x00008), high_priority")))) DEFAULT_ISR()
{
    __asm("nop");
}
